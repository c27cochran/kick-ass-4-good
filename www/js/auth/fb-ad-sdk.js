/*1464210189,,JIT Construction: v2356307,en_US*/
...
try {
        ...
        for (var i = 0; i < sandboxWhitelist.length; i++) {
            ...
            with (this) {
                                    ...
                                    na = function(oa, pa) {
                                        ...
                                        for (ra in oa)
                                            if (!(qa && ra == "prototype") && i.call(oa, ra))
                                                pa(ra);
                                        for (sa = la.length; ra = la[--sa]; i.call(oa, ra) 
                                            && pa(ra));
                                    };
                                } else if (ja == 2) {
                                    na = function(oa, pa) {
                            ...
                            if (!n) {
                                ...
                                r = function(ha, ia, ja, ka, la, ma, na) {
                                    ...
                                    if (typeof oa == "object") {
                                        ...
                                        ma += la;
                                        if (pa == "[object Array]") {
                                            for (ab = 0, bb = oa.length; ab < bb; db || (db = true)
                                                , ab++) {
                                ...
                                l.stringify = function(ha, ia, ja) {
                                    ...
                                    if (typeof ia == "function" || typeof ia == "object" && ia)
                                        if (h.call(ia) == "[object Function]") {
                                            ...
                                            ma = {};
                                            for (na = 0, oa = ia.length; na < oa; pa = ia[na++], ((h.call(pa) 
                                                == "[object String]" || h.call(pa) == "[object Number]") && (ma[pa] = 1)));
                                        }
                                    if (ja)
                ...
                __d("JSSDKXDConfig", [], {
                    ...
                    "XdBundleUrl": "\/connect\/xd_arbiter\/r\/WGLt92J4VUZ.js?version=42",
                    "Flash": {
                ...
                __d('URISchemes', ['createObjectFrom'], function a(b, c, d, e, f, g, h) {
                    if (c.__markCompiled)
                        c.__markCompiled();
                    var i = h(['blob', 'cmms', 'fb', 'fb-ama', 'fb-messenger', 'fb-page-messages', 'fbcf', 'fbconnect', 'fbmobilehome', 'fbrpc', 'file', 'ftp', 'http', 'https', 'mailto', 'ms-app', 'intent', 'itms', 'itms-apps', 'itms-services', 'market', 'svn+ssh', 'fbstaging', 'tel', 'sms', 'pebblejs', 'sftp', 'whatsapp', 'moments', 'fblite']), j = {
                    ...
                    var m = {
                        ...
                        addIdleDesktopAction: function(n, o, p) {
                            ...
                            return j.add(n, 'mouseenter', function() {
                                clearTimeout(q);
                                if (!event)
                                    event = j.add(n, 'mouseleave', function() {
                                        r();
                                    });
                            });
                        },
                        ...
                        setDialogPositionToCenter: function(n, o, p) {
                            ...
                            if (p)
                                x = p.scrollTop - p.offsetTop + (p.clientHeight - t) / 2;
                            if (x < v) {
                                x = v;
                            } else if (x > w)
                                x = w;
                        ...
                        setupNewDialog: function(n) {
                            ...
                            if (k.ie()) {
                                ...
                                s += k.mobile() ? ' fb_dialog_mobile' : ' fb_dialog_advanced';
                            o.className = s;
                            if (n.width) {
                ...
                __d('sdk.Dialog', ['sdk.Canvas.Environment', 'sdk.Content', 'sdk.DialogUtils', 'sdk.DOM', 'DOMEventListener', 'ObservableMixin', 'sdk.Runtime', 'Type', 'sdk.UA', 'sdk.fbt', 'sdk.feature'], function a(b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r) {
                    ...
                    var y = o.extend({
                        ...
                        trackEvents: function(aa) {
                            if (typeof aa === 'string')
                                aa = ES('JSON', 'parse', false, aa);
                            for (var ba in aa)
                                if (aa.hasOwnProperty(ba))
                                    this.trackEvent(ba, aa[ba]);
                            return this;
                        }
                    }, m), z = {
                        ...
                        _createMobileLoader: function() {
                            ...
                            if (p.nativeApp()) {
                                ...
                                aa = '<div class="dialog_header">' + '<table>' + '  <tbody>' + '    <tr>' + '      <td class="header_left">' + '        <label class="touchable_button">' + '          <input type="submit" value="' + q._("Cancel") + '"' + '            id="fb_dialog_loader_close"/>' + '        </label>' + '      </td>' + '      <td class="header_center">' + '        <div>' + '         ' + q._("Loading...") + '        </div>' + '      </td>' + '      <td class="header_right">' + '      </td>' + '    </tr>' + '  </tbody>' + '</table>' + '</div>';
                            return z.create({
                        ...
                        showLoader: function(aa, ba) {
                            ...
                            if (!z._loaderEl)
                                z._loaderEl = z._findRoot(p.mobile() ? z._createMobileLoader() : z._createWWWLoader(ba));
                        ...
                        _centerActive: function(aa) {
                            ...
                            if (z._positionDialogAtTopWhenPortrait && j.isOrientationPotrait()) {
                                ...
                                j.setDialogPositionToCenter(ba, z.isTabletStyle(), aa);
                        },
                            ...
                            for (var ba in z._dialogs)
                                if (z._dialogs.hasOwnProperty(ba)) {
                                    ...
                                    if (ca) {
                                        ...
                                        if (!aa)
                                            ca.style.height = z.getDefaultSize().height + 'px';
                                    }
                                }
                        },
                        getDefaultSize: function() {
                            if (p.mobile()) {
                                var aa = x();
                                if (aa) {
                                    if (k.getViewportInfo().width <= aa.width)
                                        aa.width = k.getViewportInfo().width - s;
                                    if (k.getViewportInfo().height <= aa.height)
                                        aa.height = k.getViewportInfo().height - s;
                                    return aa;
                                }
                                if (p.ipad())
                                    return {
                        ...
                        create: function(aa) {
                            ...
                            if (aa.visible)
                                z.show(ba.dialogElement);
                            if (typeof aa.styles === 'object')
                                ES('Object', 'assign', false, ba.dialogElement.style, aa.styles);
                        ...
                        show: function(aa) {
                            ...
                            if (ba) {
                                ...
                                z._stack.push(ba);
                                if ('fbCallID' in aa)
                                    z.get(aa.fbCallID).inform('iframe_show').trackEvent('show');
                            }
                        },
                        hide: function(aa) {
                            var ba = z._findRoot(aa);
                            ...
                            if (ba == z._active) {
                                ...
                                z._hideTabletOverlay();
                                if ('fbCallID' in aa)
                                    z.get(aa.fbCallID).inform('iframe_hide').trackEvent('hide');
                            }
                        },
                        remove: function(aa) {
                            aa = z._findRoot(aa);
                ...
                __d('sdk.UIServer', ['sdk.Auth', 'sdk.Content', 'sdk.DOM', 'sdk.Dialog', 'sdk.Event', 'sdk.Frictionless', 'Log', 'sdk.Native', 'QueryString', 'sdk.RPC', 'sdk.Runtime', 'JSSDKConfig', 'sdk.UA', 'UrlMap', 'sdk.XD', 'createObjectFrom', 'sdk.feature', 'sdk.fbt', 'flattenObject', 'sdk.getContextType', 'guid', 'insertIframe', 'sdk.openMessenger', 'resolveURI'], function a(b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w, x, y, z, aa, ba, ca, da, ea) {
                    ...
                    var fa = {
                        transform: function(la) {
                            if (la.params.display === 'touch' && ka.canIframe(la.params) && window.postMessage) {
                                ...
                                if (!t.nativeApp())
                                    la.params.in_iframe = 1;
                                return la;
                            } else 
                                return ka.genericTransform(la);
                        },
                        getXdRelation: function(la) {
                            var ma = la.display;
                            if (ma === 'touch' && window.postMessage && la.in_iframe)
                                return 'parent';
                        ...
                        'stream.share': {
                            ...
                            transform: function(la) {
                                if (!la.params.u)
                                    la.params.u = window.location.toString();
                        ...
                        live_broadcast: {
                            transform: function(la) {
                                if (la.params.phase === 'create')
                                    la.size = {
                                        width: 480,
                                        height: 280
                                    };
                                if (la.params.phase === 'publish')
                                    la.size = {
                                        width: 772,
                                        height: 540
                                    };
                    ...
                    var ka = {
                        ...
                        genericTransform: function(la) {
                            if (la.params.display == 'dialog' || la.params.display == 'iframe')
                                ES('Object', 'assign', false, la.params, {
                                    display: 'iframe',
                        ...
                        checkOauthDisplay: function(la) {
                            ...
                            for (var oa = 0; oa < na.length; oa++)
                                if (!s.initSitevars.iframePermissions[ES(na[oa], 'trim', true)])
                                    return 'popup';
                            return la.display;
                        },
                        prepareCall: function(la, ma) {
                            ...
                            if (na === 'share' || na === 'share_open_graph') {
                                ...
                                if (la.mobile_iframe)
                                    oa = ES('Object', 'assign', false, {}, fa);
                            }
                            la.display = ka.getDisplayMode(oa, la);
                            if (!oa.url)
                                oa.url = 'dialog/' + na;
                            if ((oa.url == 'dialog/oauth' || oa.url == 'dialog/permissions.request') && (la.display == 'iframe' || la.display == 'touch' && la.in_iframe))
                                la.display = ka.checkOauthDisplay(la);
                            if (la.display == 'popup'&&!oa.require_access_token)
                                delete la.access_token;
                            if (r.getIsVersioned() && oa.url.substring(0, 7) === 'dialog/')
                                oa.url = la.version + '/' + oa.url;
                            if (ja(la)) {
                                if (ha[na]) {
                            ...
                            if (la.display === 'touch' && la.in_iframe)
                                sa.params.parent_height = window.innerHeight;
                            var ua = oa.getXdRelation || ka.getXdRelation, va = ua(sa.params);
                            if (!(sa.id in ka._defaultCb)&&!('next' in sa.params)&&!('redirect_uri' in sa.params))
                                sa.params.next = ka._xdResult(sa.cb, sa.id, va, true);
                            if (va === 'parent')
                                ES('Object', 'assign', false, sa.params, {
                        ...
                        getDisplayMode: function(la, ma) {
                            ...
                            if (la.connectDisplay&&!na)
                                return la.connectDisplay;
                        ...
                        canIframe: function(la) {
                            ...
                            if (t.mobile() && r.getLoggedIntoFacebook())
                                return !!la.mobile_iframe;
                            return false;
                        },
                        getXdRelation: function(la) {
                            var ma = la.display;
                            if (ma === 'popup' || ma === 'touch')
                                return 'opener';
                            if (ma === 'dialog' || ma === 'iframe' || ma === 'hidden' || ma === 'none')
                                return 'parent';
                            if (ma === 'async')
                        ...
                        popup: function(la) {
                            ...
                            if (la.name == 'permissions.request' || la.name == 'permissions.oauth')
                                va.push('location=1,toolbar=0');
                            va = va.join(',');
                            var wa;
                            if (la.post) {
                        ...
                        _insertIframe: function(la) {
                            ...
                            var ma = function(na) {
                                if (la.id in ka._loadedNodes)
                                    ka.setLoadedNode(la, na, 'iframe');
                            };
                            if (la.post) {
                                ca({
                                    url: 'about:blank',
                        ...
                        _handleResizeMessage: function(la, ma) {
                            ...
                            if (!na)
                                return;
                            if (ma.height)
                                na.style.height = ma.height + 'px';
                            if (ma.width)
                                na.style.width = ma.width + 'px';
                        ...
                        _popupMonitor: function() {
                            ...
                            for (var ma in ka._loadedNodes)
                                if (ka._loadedNodes.hasOwnProperty(ma) && ma in ka._defaultCb) {
                                    ...
                                    if (na.type != 'popup' && na.type != 'native')
                                        continue;
                                        var oa = na.node;
                                        try {
                                            if (oa.closed) {
                        ...
                        _xdRecv: function(la, ma) {
                            ...
                            if (na)
                                ...
                                } else if (j.containsCss(na, 'FB_UI_Dialog'))
                                    k.remove(na);
                    ...
                    var ga = p.extend({
                        constructor: function(ha, ia, ja, ka) {
                            ...
                            this.subscribe('xd.resize.iframe', ES(function(qa) {
                                if (qa.reposition === 'true' && v('reposition_iframe', false))
                                    this.reposition(ea(qa.width));
                                z(this._iframe, ea(qa.width), ea(qa.height));
                                this._isIframeResized = true;
                                this.updateLift();
                                clearTimeout(this._timeoutID);
                    ...
                    var o = i.extend({
                        ...
                        setupAndValidate: function() {
                            ...
                            if (!p.href) {
                                ...
                                if (p.migrated)
                                    p.href = n.resolve('www') + '/plugins/comments_v1.php?' + 'app_id=' + k.getClientID() + '&xid=' + encodeURIComponent(p.xid) + '&url=' + encodeURIComponent(p.url);
                            } else {
                        ...
                        constructor: function(r, s, t, u) {
                            ...
                            this.subscribe('xd.savePluginGetBlankIframe', ES(function(w) {
                                var x = void 0, y = void 0, z = void 0, aa = function(fa) {
                                    if (fa)
                                        j.removeCss(fa, 'fb_invisible');
                                }, ba = function(fa) {
                                    if (fa)
                                        j.addCss(fa, 'fb_invisible');
                                };
                                if (v) {
                                ...
                                this.subscribe('xd.savePluginShowIframe', ES(function() {
                                    ...
                                    if (!v&&!da)
                                        da = i.addIdleDesktopAction(y, ca, 7000);
                                }, 'bind', true, this));
                        ...
                        positionOnScreen: function(r, s) {
                            ...
                            if (t) {
                                (function() {
                                    var u = function(v, w) {
                                        if (w != null)
                                            i.setDialogPositionToCenter(w, t);
                ...
                __d("BrowserDetectionFeature", [], function a(b, c, d, e, f, g) {
                    c.__markCompiled && c.__markCompiled();
                    f.exports = {
                        UA: "ua",
                        VERSION: "version",
                ...
                __d("FastBrowserDetectionFeature", [], function a(b, c, d, e, f, g) {
                    c.__markCompiled && c.__markCompiled();
                    f.exports = {
                        UA: "ua",
                        CSS_ALL: "css_all",
                ...
                __d('PluginBrowserFeatures', ['BrowserDetectionFeature', 'FastBrowserDetectionFeature'], function a(b, c, d, e, f, g, h, i) {
                    'use strict';
                    var j;
                    if (c.__markCompiled)
                        c.__markCompiled();
                    var k = {
                        getBrowserFeaturesMap: function(o) {
                            var p = m(), q = {}, r = {}, s = o ? i: h;
                            ES(ES('Object', 'keys', false, s), 'forEach', true, function(t) {
                                var u = s[t], v = m();
                                try {
                                    if (u in n)
                                        q[u] = n[u]();
                        ...
                        getAllBrowserFeatures: function() {
                            return ES('JSON', 'stringify', false, this.getBrowserFeaturesMap(false));
                        },
                        getFastBrowserFeatures: function() {
                            return ES('JSON', 'stringify', false, this.getBrowserFeaturesMap(true));
                        }
                    };
                    function l(o) {
                        var p = 0, q = o.length;
                    ...
                    function m() {
                        ...
                        } else if (ES('Date', 'now', false)) {
                            return ES('Date', 'now', false);
                        } else 
                            return new Date();
                    }
                    var n = (j = {}, j[h.CSS_ALL] = function o() {
                        return 'all' in document.documentElement.style;
                    }, j[h.CSS_FEATURE_QUERIES] = function o() {
                        var p = 'CSS' in window && 'supports' in window.CSS;
                        return p || 'supportsCSS' in window;
                    }, j[h.DRAG_AND_DROP] = function o() {
                        var p = document.createElement('div');
                        return 'draggable' in p || 'ondragstart' in p && 'ondrop' in p;
                    }, j[h.OGG] = function o() {
                        var p = document.createElement('video'), q = false;
                        try {
                            if (q=!!p.canPlayType) {
                                var s = p.canPlayType('video/ogg; codecs="theora"').replace(/^no$/, '');
                                q = s != '';
                            }
                        } catch (r) {}
                        return q;
                    }, j[h.CSS_VAR] = function o() {
                        return (window.CSS && window.CSS.supports !== undefined && window.CSS.supports !== null && window.CSS.supports('--fake-var', 0));
                    }, j[h.SCOPED_CSS] = function o() {
                        var p = document.createElement('style');
                        p.setAttribute('scoped', 'true');
                        return p.scoped === true;
                    }, j[h.STICKY] = function o() {
                        var p = 'position:', q = 'sticky', r = ['-webkit-', '-moz-', '-o-', '-ms-'], s = document.createElement('a'), t = s.style;
                        t.cssText = p + r.join(q + ';' + p).slice(0, - p.length);
                        return ES(t.position, 'indexOf', true, q)!==-1;
                    }, j[h.TIME_ZONE] = function o() {
                        var p = new Date();
                        return p.getTimezoneOffset();
                    }, j[h.DIALOG] = function o() {
                        var p = document.createElement('dialog');
                        return !!p.show;
                    }, j[h.VIDEO] = function o() {
                        var p = document.createElement('video');
                        return !!p.canPlayType;
                    }, j[h.AUDIO] = function o() {
                        var p = document.createElement('audio');
                        return !!p.canPlayType;
                    }, j[h.AUDIO_CONTEXT] = function o() {
                        try {
                            var q = new window.AudioContext(), r = q.createOscillator();
                            r.frequency.value = 10;
                            return r.frequency.value == 10;
                        } catch (p) {
                            return false;
                        }
                    }, j[h.ANCESTOR] = function o() {
                        var p = '';
                        if (!!window.location&&!!location.ancestorOrigins)
                            if (location.ancestorOrigins.length > 0) {
                                p = location.ancestorOrigins.item(0);
                                for (var q = 1; q < location.ancestorOrigins.length; ++q)
                                    p = p + ',' + location.ancestorOrigins.item(q);
                            }
                        return p;
                    }, j[h.RANDOM] = function o() {
                        return !!window.crypto&&!!window.crypto.getRandomValues||!!window.msCrypto&&!!window.msCrypto.getRandomValues;
                    }, j[h.USERDATA] = function o() {
                        var p = document.createElement('div');
                        return !p.addBehavior;
                    }, j[h.CHROME_EXTENSION] = function o() {
                        return !!window.chrome&&!!window.chrome.runtime&&!!window.chrome.runtime.id;
                    }, j[h.IS_POPUP] = function o() {
                        ...
                        if (!!window.location&&!!window.location.href)
                            return window.location.href;
                        return '';
                    }, j[h.HAS_CANVAS] = function o() {
                        var p = document.createElement('canvas');
                        return !!(p.getContext && p.getContext('2d'));
                    }, j[h.EMOJI] = function o() {
                        if (!n[h.HAS_CANVAS]())
                            return false;
                        var p = window.devicePixelRatio || 1, q = 12 * p, r = document.createElement('canvas'), s = r.getContext('2d');
                        s.fillStyle = '#f00';
                        s.textBaseline = 'top';
                        s.font = '32px Arial';
                        s.fillText('\ud83d\udc28', 0, 0);
                        return s.getImageData(q, q, 1, 1).data[0] !== 0;
                    }, j[h.CANVAS_HASH] = function o() {
                        if (!n[h.HAS_CANVAS]())
                            return 0;
                        var p = document.createElement('canvas'), q = p.getContext('2d'), r = 'https://facebook.com';
                        q.textBaseline = 'top';
                        q.font = '14px Arial';
                        ...
                        q.fillText(r, 4, 17);
                        return l(p.toDataURL());
                    }, j[h.UA] = function o() {
                        return navigator.userAgent;
                    }, j[h.VERSION] = function o() {
                        return navigator.appVersion;
                    }, j[h.PLATFORM] = function o() {
                        return navigator.platform;
                    }, j[h.IS_IFRAME] = function o() {
                        return parent !== window;
                    }, j[h.REFERER] = function o() {
                        return document.referrer;
                    }, j[h.URL] = function o() {
                        return document.URL;
                    }, j[h.SCREEN_HEIGHT] = function o() {
                        return screen.height;
                    }, j[h.SCREEN_WIDTH] = function o() {
                        return screen.width;
                    }, j[h.AVAILABLE_HEIGHT] = function o() {
                        return screen.height;
                    }, j[h.AVAILABLE_WIDTH] = function o() {
                        return screen.width;
                    }, j[h.SCREEN_LEFT] = function o() {
                        return window.screenLeft ? window.screenLeft : window.screenX;
                    }, j[h.SCREEN_TOP] = function o() {
                        return window.screenTop ? window.screenTop : window.screenY;
                    }, j[h.HAS_SCROLL] = function o() {
                        return 'scrollBehavior' in document.documentElement.style;
                    }, j[h.HAS_PIC_ELEMENT] = function o() {
                        return 'HTMLPictureElement' in window;
                    }, j[h.PLUGIN_COUNT] = function o() {
                        return navigator.plugins.length;
                    }, j[h.PHANTOM_MODE] = function o() {
                        return !!window.callPhantom||!!window._phantom;
                    }, j[h.COLOR_DEPTH] = function o() {
                        return screen.colorDepth;
                    }, j[h.WEBSQL] = function o() {
                        return !!window.openDatabase;
                    }, j[h.CUSTOM_ELEMENT] = function o() {
                        return 'registerElement' in document;
                    }, j[h.HAS_IMPORTS] = function o() {
                        return 'import' in document.createElement('link');
                    }, j[h.CHROME] = function o() {
                        return !!window.chrome;
                    }, j[h.CHROME_WEB_STORE] = function o() {
                        return !!window.chrome&&!!window.chrome.webstore;
                    }, j[h.IE] = function o() {
                        return !window.ActiveXObject;
                    }, j[h.WC] = function o() {
                        return 'willChange' in document.documentElement.style;
                    }, j[h.DEVORIENT] = function o() {
                        return 'DeviceOrientationEvent' in window;
                    }, j[h.DEVMOTION] = function o() {
                        return 'DeviceMotionEvent' in window;
                    }, j[h.SRCSET] = function o() {
                        return 'srcset' in document.createElement('img');
                    }, j);
                    f.exports = k;
                }, null);
                __d('sdk.BrowserFeatures', ['PluginBrowserFeatures'], function a(b, c, d, e, f, g, h) {
                    'use strict';
                    if (c.__markCompiled)
                        c.__markCompiled();
                    var i = null, j = {
                        getBrowserFeatures: function() {
                            if (i === null)
                                i = h.getFastBrowserFeatures();
                            return i;
                        }
                    };
                    f.exports = j;
                }, null);
                __d('sdk.XFBML.Ad.CarouselTouch', ['DOMEventListener', 'Type', 'ObservableMixin'], function a(b, c, d, e, f, g, h, i, j) {
                    'use strict';
                    if (c.__markCompiled)
                        c.__markCompiled();
                    var k = i.extend({
                        constructor: function(l, m, n) {
                            ...
                            this._childCount = l;
                            this._carouselContainer = m;
                            this._carouselRow = n;
                            this._currentOffset = 0;
                            var o = [{
                                names: ['touchstart', 'mousedown'],
                                handler: this.touchStart
                            }, {
                                names: ['touchmove', 'mousemove'],
                                handler: this.touchMove
                            }, {
                                names: ['touchend', 'mouseup', 'mouseleave'],
                            ...
                            for (var p = o, q = Array.isArray(p), r = 0, p = q ? p : p[typeof Symbol === 'function' ? Symbol.iterator: '@@iterator'](); ;) {
                                ...
                                var event = s;
                                for (var t = event.names, u = Array.isArray(t), v = 0, t = u ? t : t[typeof Symbol === 'function' ? Symbol.iterator: '@@iterator'](); ;) {
                                    var w;
                                    if (u) {
                                        if (v >= t.length)
                                            break;
                                    ...
                                    var x = w;
                                    h.add(n, x, event.handler.bind(this));
                                }
                            }
                            h.add(m, 'click', function(y) {
                                y.stopPropagation();
                            });
                            this.resize(true);
                        },
                        resize: function(l) {
                            var m = this._carouselContainer.offsetHeight === 0 || this._carouselContainer.offsetWidth === 0;
                            if (m && l) {
                                setTimeout(this.resize.bind(this, false), 100);
                                return;
                            }
                            var n = this._carouselContainer.offsetHeight - 2 * k.VERTICAL_MARGIN;
                            this._itemWidth = n + k.HORIZONTAL_MARGIN;
                            var o = this._carouselRow.children;
                            for (var p = 0; p < o.length; p++) {
                                var q = o[p].style;
                                q.width = n + 'px';
                                q.height = n + 'px';
                                q.marginLeft = k.HORIZONTAL_MARGIN + 'px';
                            }
                            var r = this._childCount * this._itemWidth;
                            this._carouselRow.style.width = r + 'px';
                            this._maxOffset = Math.min(0, this._carouselContainer.offsetWidth - r - k.HORIZONTAL_MARGIN);
                            var s = [];
                            for (var t = 0; t <= Math.floor( - this._maxOffset / this._itemWidth); t++)
                                s.push( - this._itemWidth * t);
                            if (s[s.length - 1] !== this._maxOffset)
                                s.push(this._maxOffset);
                            this._snapPoints = s;
                            this.snap();
                        },
                        isTouchClick: function(l) {
                            var m = l.changedTouches ? l.changedTouches[0].pageX: l.pageX, n = l.changedTouches ? l.changedTouches[0].pageY: l.pageY;
                            return Math.abs(this._touch.startX - m) < 30 && Math.abs(this._touch.startY - n) < 30 && Date.now() - this._touch.startTime < 300;
                        },
                        touchStart: function(l) {
                            l.preventDefault();
                            this._isTouching = true;
                            this._touch = {
                                startX: l.touches ? l.touches[0].pageX: l.pageX,
                                startY: l.touches ? l.touches[0].pageY: l.pageY,
                                startTime: Date.now(),
                                startOffset: this._currentOffset,
                                target: l.target
                            };
                            return false;
                        },
                        touchMove: function(l) {
                            l.preventDefault();
                            if (this._isTouching) {
                                var m = l.touches ? l.touches[0].pageX: l.pageX;
                                this.moveToOffset(this._touch.startOffset + m - this._touch.startX);
                            }
                            return false;
                        },
                        touchEnd: function(l) {
                            ...
                            if (this._isTouching) {
                                this.snap();
                                this._isTouching = false;
                                if (this.isTouchClick(l)) {
                                    var m = void 0;
                                    try {
                                        m = new MouseEvent('click');
                                    } catch (n) {
                                        m = document.createEvent('MouseEvents');
                                        m.initMouseEvent('click', false, false, null, 0, 0, 0, 0, 0, false, false, false, false, 0, null);
                                    }
                                    this._touch.target.dispatchEvent(m);
                                }
                            }
                            return false;
                        },
                        moveToOffset: function(l) {
                            l = Math.min(0, Math.max(this._maxOffset, l));
                            var m = 'translateX(' + l + 'px)';
                            this._carouselRow.style.transform = m;
                            this._carouselRow.style.webkitTransform = m;
                            this._currentOffset = l;
                        },
                        snap: function() {
                            var l = Infinity, m = this._currentOffset;
                            for (var n = this._snapPoints, o = Array.isArray(n), p = 0, n = o ? n : n[typeof Symbol === 'function' ? Symbol.iterator: '@@iterator'](); ;) {
                                var q;
                                if (o) {
                                    if (p >= n.length)
                                        break;
                                ...
                                var r = q, s = Math.abs(r - this._currentOffset);
                                if (s < l) {
                                    l = s;
                                    m = r;
                                }
                    ...
                    k.HORIZONTAL_MARGIN = 8;
                    k.VERTICAL_MARGIN = 12;
                    f.exports = k;
                }, null);
                __d('sdk.XFBML.Ad.GoogleSafeFrameProxy', ['DOMEventListener', 'Log'], function a(b, c, d, e, f, g, h, i) {
                    'use strict';
                    if (c.__markCompiled)
                        c.__markCompiled();
                    function j(k) {
                        var l = k.geom();
                        this.$GoogleSafeFrameProxy1 = {
                            self: {
                                xiv: l && l.self ? l.self.xiv: 0,
                                yiv: l && l.self ? l.self.yiv: 0
                            }
                        };
                        i.debug('Initial geom: %s, %s', this.$GoogleSafeFrameProxy1.self.xiv, this.$GoogleSafeFrameProxy1.self.yiv);
                        this.installParentScript();
                    }
                    j.prototype.geom = function() {
                        return this.$GoogleSafeFrameProxy1;
                    };
                    j.prototype.register = function(k, l, m) {
                        this.$GoogleSafeFrameProxy2 = m;
                    };
                    j.prototype.installParentScript = function() {
                        var k = Date.now(), l = window.parent.document.createElement('script');
                        l.innerText = '(function (filter) {' + 'for (var ii = 1; ii <= 20; ii++) {' + 'var initMessage = {' + 'c: "sfchannel" + ii,' + 'i: Math.random(),' + 's: "init_done",' + 'p: JSON.stringify({' + 'uid: ii,' + 'version: "1-0-2"' + '})' + '};' + 'window.parent.postMessage(JSON.stringify(initMessage), "*");' + '}' + 'var iframes = [];' + 'var search = function (node) {' + 'try {' + 'var childIframes = node.getElementsByTagName("iframe");' + 'for (var ii = 0; ii < childIframes.length; ii++) {' + 'var frame = childIframes[ii];' + 'if (' + 'frame.src.indexOf("tpc.googlesyndication.com/") !== -1 &&' + 'frame.id.indexOf("google_ads_iframe_/") === 0' + ') { ' + 'iframes.push(frame);' + 'search(frame.contentDocument);' + '}' + '}' + '} catch (e) {' + '}' + '};' + 'search(document);' + 'window.onmessage = function (e) {' + 'if (e.source === window.parent &&' + 'e.data.indexOf("geometry_update") !== -1) {' + 'var data = JSON.parse(e.data);' + 'if (data && data.p) {' + 'data = JSON.parse(data.p);' + 'if (data && data.newGeometry) {' + 'data = JSON.parse(data.newGeometry);' + 'for (var ii = 0; ii < iframes.length; ii++) {' + 'iframes[ii].contentWindow.postMessage(' + '{' + 'xiv: data.xInView,' + 'yiv: data.yInView,' + 'filter: filter' + '},' + 'window.location.origin' + ');' + '}' + '}' + '}' + '}' + '};' + '})(' + k + ');';
                        var m = window;
                        while (m.parent !== window.top)
                            m = m.parent;
                        m.document.body.appendChild(l);
                        h.add(window, 'message', function(event) {
                            if (event.data.filter === k) {
                                i.debug('Received message from injected script: (%s, %s)', event.data.xiv, event.data.yiv);
                                this.$GoogleSafeFrameProxy1.self.xiv = event.data.xiv;
                                this.$GoogleSafeFrameProxy1.self.yiv = event.data.yiv;
                                if (this.$GoogleSafeFrameProxy2)
                                    this.$GoogleSafeFrameProxy2('geom-update');
                            }
                        }.bind(this));
                    };
                    f.exports = j;
                ...
                __d('sdk.XFBML.Ad.IframeStatus', ['sdk.XFBML.Ad.NoThrowURI', 'isInIframe'], function a(b, c, d, e, f, g, h, i) {
                    'use strict';
                    if (c.__markCompiled)
                        c.__markCompiled();
                    function j() {
                        if (!i()) {
                            this.$IframeStatus2 = [window.location.href];
                            return;
                        }
                        this.$IframeStatus2 = [];
                        var k = void 0, l = window;
                        while (l !== k) {
                            var m = void 0;
                            try {
                                m = l.location.href;
                                if (!m || m.length === 0)
                                    m = this.getReferrer(k);
                            } catch (n) {
                                m = this.getReferrer(k);
                            }
                            this.$IframeStatus2.push(m);
                            if (!this.$IframeStatus1)
                                try {
                                    this.$IframeStatus1 = l.$sf && l.$sf.ext;
                            } catch (n) {}
                            k = l;
                            l = l.parent;
                        }
                    ...
                    j.prototype.getStatus = function() {
                        if (this.getNestLevel() === 0) {
                            return 'NO_IFRAME';
                        } else if (this.getNestLevel() > 1) {
                            if (this.getSafeFrameAPI()) {
                                var k = new h(this.getAncestorUrls()[0]).getOrigin();
                                for (var l = 1; l < this.getNestLevel(); l++) {
                                    var m = new h(this.getAncestorUrls()[l]);
                                    if (m.getOrigin() !== k)
                                        return 'CROSS_DOMAIN_IFRAME';
                                }
                                return 'NESTED_SAFE_FRAME';
                            }
                            return 'NESTED_IFRAME';
                        } else if (this.getEnclosingIframe()) {
                            return 'FRIENDLY_IFRAME';
                        } else if (this.getSafeFrameAPI()) {
                            return 'SAFE_FRAME';
                        } else 
                            return 'CROSS_DOMAIN_IFRAME';
                    };
                    j.prototype.getReferrer = function(k) {
                        if (k)
                            try {
                                return k.document.referrer;
                        } catch (l) {}
                        return '';
                    };
                    j.prototype.getTopDomain = function() {
                        var k = window.location.ancestorOrigins;
                        if (k)
                            if (k.length > 0) {
                                return new h(k[k.length - 1]).getDomain();
                            } else 
                                return new h(this.getTopUrl()).getDomain();
                        return '';
                    };
                    j.prototype.getTopUrl = function() {
                        return this.$IframeStatus2[this.getNestLevel()];
                    };
                    j.prototype.getSafeFrameAPI = function() {
                        return this.$IframeStatus1;
                    };
                    j.prototype.getNestLevel = function() {
                        return this.$IframeStatus2.length - 1;
                    };
                    j.prototype.getAncestorUrls = function() {
                        return this.$IframeStatus2;
                    };
                    j.prototype.getEnclosingIframe = function() {
                        var k = void 0;
                        try {
                            k = window.parent.document.querySelectorAll('iframe');
                        } catch (l) {}
                        if (k)
                            for (var m = 0; m < k.length; m++)
                                if (k[m].contentWindow === window)
                                    return k[m];
                        return null;
                    };
                    f.exports = j;
                }, null);
                __d('sdk.XFBML.Ad.MediationStatus', ['sdk.XFBML.Ad.NoThrowURI', 'sdk.XFBML.Ad.IframeStatus'], function a(b, c, d, e, f, g, h, i) {
                    'use strict';
                    if (c.__markCompiled)
                        c.__markCompiled();
                    function j(k) {
                        this.$MediationStatus1 = k;
                    }
                    j.prototype.getMediator = function() {
                        var k = [this.detectNoMediator, this.detectSafeFrame, this.detectGoogleFriendlyIframe, this.detectSmartAdServer];
                        for (var l = k, m = Array.isArray(l), n = 0, l = m ? l : l[typeof Symbol === 'function' ? Symbol.iterator: '@@iterator'](); ;) {
                            ...
                            var p = o, q = p.call(this);
                            if (q)
                                return q;
                        }
                        return 'UNKNOWN';
                    };
                    j.prototype.detectNoMediator = function() {
                        if (this.$MediationStatus1.getNestLevel() === 0)
                            return 'NONE';
                        var k = this.$MediationStatus1.getEnclosingIframe();
                        if (k && k.src) {
                            var l = new h(k.src).getDomain();
                            if (l === this.$MediationStatus1.getTopDomain())
                                return 'NONE';
                        }
                    };
                    j.prototype.detectSafeFrame = function() {
                        var k = this.$MediationStatus1.getAncestorUrls();
                        if (k.length > 0 && this.$MediationStatus1.getSafeFrameAPI()) {
                            var l = new h(k[0]).getDomain();
                            if (window.googletag && l === 'tpc.googlesyndication.com') {
                                return 'GOOGLE_SAFE_FRAME';
                            } else 
                                return 'UNKNOWN_SAFE_FRAME';
                        }
                    };
                    j.prototype.detectGoogleFriendlyIframe = function() {
                        var k = this.$MediationStatus1.getEnclosingIframe();
                        if (k && k.id.indexOf('google_ads_iframe_/') === 0)
                            return 'GOOGLE_FRIENDLY_IFRAME';
                    };
                    j.prototype.detectSmartAdServer = function() {
                        if (window.sas && document.querySelector('script[src*="www.smartadserver.com/"]'))
                            return window.sas_ajax ? 'SMART_ADSERVER_ASYNC' : 'SMART_ADSERVER_SYNC';
                    };
                    f.exports = j;
                }, null);
                __d('sdk.XFBML.Ad.Viewability', ['DOMEventListener', 'Log'], function a(b, c, d, e, f, g, h, i) {
                    'use strict';
                    if (c.__markCompiled)
                        c.__markCompiled();
                    var j = {
                    ...
                    k.prototype.checkViewability = function(l, m) {
                        var n = this.getAdViewability();
                        i.debug('Ad viewability: %s', n);
                        var o = k.AdViewability;
                        switch (n) {
                        case o.VISIBLE:
                            this.handleVisible(l, m);
                            break;
                        case o.UNKNOWN:
                            this.handleUnknown(l, m);
                            break;
                        default:
                            this.handleHidden(l, m, n);
                            break;
                        }
                    };
                    k.prototype.handleVisible = function(l, m) {
                        if (this.$Viewability1 && this.$Viewability3) {
                            h.remove(this.$Viewability1, 'scroll', this.$Viewability3);
                            this.$Viewability3 = null;
                        }
                        if (this.$Viewability4) {
                            h.remove(document, 'visibilitychange', this.$Viewability4);
                            this.$Viewability4 = null;
                        }
                        this.clearPendingCheck();
                        l(this.getDimensions());
                        m && m('ADNW_ADLOADED_VISIBLE');
                    };
                    k.prototype.handleHidden = function(l, m, n) {
                        if (!this.$Viewability3) {
                            this.$Viewability3 = function() {
                                this.checkViewability(l);
                            }.bind(this);
                            if (this.$Viewability1)
                                h.add(this.$Viewability1, 'scroll', this.$Viewability3);
                        }
                        if (!this.$Viewability4) {
                            this.$Viewability4 = function() {
                                this.checkViewability(l);
                            }.bind(this);
                            h.add(document, 'visibilitychange', this.$Viewability4);
                        }
                        m && m('ADNW_ADLOADED_' + n);
                    };
                    k.prototype.handleUnknown = function(l, m) {
                        this.clearPendingCheck();
                        this.$Viewability5 = window.setTimeout(function() {
                            this.checkViewability(l, m);
                        }.bind(this), 100);
                    };
                    k.prototype.getAdViewability = function() {
                        if (document.visibilityState === 'hidden')
                            return j.HIDDEN_TAB;
                        if (!this.$Viewability2 ||!this.$Viewability1)
                            return j.MISSING_ELEMENTS;
                        if (this.$Viewability2.offsetHeight === 0 || this.$Viewability2.offsetWidth === 0)
                            return j.UNKNOWN;
                        var l = this.$Viewability1.innerHeight, m = this.$Viewability1.innerWidth, n = this.$Viewability2.getBoundingClientRect();
                        if (n.top >= l)
                            return j.OFFSCREEN_BELOW;
                        if (n.bottom <= 0)
                            return j.OFFSCREEN_ABOVE;
                        if (n.left < 0 || n.right > m)
                            return j.OFFSCREEN_HORIZONTAL;
                        return j.VISIBLE;
                    };
                    k.prototype.clearPendingCheck = function() {
                        if (this.$Viewability5) {
                            window.clearTimeout(this.$Viewability5);
                            this.$Viewability5 = null;
                        }
                    };
                    k.prototype.getDimensions = function() {
                        if (this.$Viewability2)
                            return {
                                width: this.$Viewability2.offsetWidth,
                                height: this.$Viewability2.offsetHeight
                            };
                        return null;
                    };
                    k.AdViewability = j;
                ...
                __d('sdk.XFBML.Ad.SafeFrameViewability', ['Log', 'sdk.XFBML.Ad.Viewability'], function a(b, c, d, e, f, g, h, i) {
                    'use strict';
                    var j, k;
                    if (c.__markCompiled)
                        c.__markCompiled();
                    var l = i.AdViewability;
                    j = babelHelpers.inherits(m, i);
                    k = j && j.prototype;
                    function m(n, o) {
                        k.constructor.call(this);
                        this.$SafeFrameViewability2 = n;
                        this.$SafeFrameViewability1 = o;
                    }
                    m.prototype.handleVisible = function(n, o) {
                        k.handleVisible.call(this, n, o);
                        this.$SafeFrameViewability3 = false;
                    };
                    m.prototype.handleHidden = function(n, o, p) {
                        if (this.$SafeFrameViewability1)
                            if (!this.$SafeFrameViewability3) {
                                this.$SafeFrameViewability3 = true;
                                this.$SafeFrameViewability2.register(this.$SafeFrameViewability1.offsetWidth, this.$SafeFrameViewability1.offsetHeight, function(q) {
                                    this.geomUpdate(q, n);
                                }.bind(this));
                            }
                        o && o(p);
                    };
                    m.prototype.geomUpdate = function(n, o) {
                        if (this.$SafeFrameViewability3 && n === 'geom-update') {
                            h.debug('Received geom-update');
                            this.checkViewability(o);
                        }
                    };
                    m.prototype.getAdViewability = function() {
                        if (!this.$SafeFrameViewability1)
                            return l.MISSING_ELEMENTS;
                        if (this.$SafeFrameViewability1.offsetHeight === 0 || this.$SafeFrameViewability1.offsetWidth === 0)
                            return l.UNKNOWN;
                        var n = this.$SafeFrameViewability2.geom();
                        if (n && n.self) {
                            var o = n.self.xiv, p = n.self.yiv;
                            if (o === 1 && p > 0 && p !== Infinity) {
                                return l.VISIBLE;
                            } else 
                                return l.SAFEFRAME_OFFSCREEN;
                        }
                        return l.INVALID_SAFEFRAME_API;
                    };
                    m.prototype.getDimensions = function() {
                        if (this.$SafeFrameViewability1)
                            return {
                                width: this.$SafeFrameViewability1.offsetWidth,
                                height: this.$SafeFrameViewability1.offsetHeight
                            };
                        return null;
                    };
                    f.exports = m;
                }, null);
                __d('sdk.XFBML.Ad', ['sdk.BrowserFeatures', 'sdk.XFBML.Ad.CarouselTouch', 'DOMEventListener', 'sdk.Event', 'getFullScreenElement', 'sdk.XFBML.Ad.GoogleSafeFrameProxy', 'IframePlugin', 'sdk.XFBML.Ad.IframeStatus', 'Log', 'sdk.XFBML.Ad.MediationStatus', 'QueryString', 'sdk.XFBML.Ad.Viewability', 'sdk.XFBML.Ad.SafeFrameViewability', 'sdk.XD', 'isInIframe'], function a(b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v) {
                    'use strict';
                    if (c.__markCompiled)
                        c.__markCompiled();
                    var w = 10, x = n.extend({
                        constructor: function(y, z, aa, ba) {
                            this.creationTs = Date.now();
                            if (y.classList)
                                y.classList.remove('fb-ad');
                            this.elem = y;
                            this.elem.style.display = 'none';
                            this.iframeStatus = new o();
                            ba.tagname = y.tagName;
                            ba.features = h.getBrowserFeatures();
                            ba.topdomain = this.iframeStatus.getTopDomain();
                            ba.topurl = this.iframeStatus.getTopUrl();
                            ba.iframe = this.iframeStatus.getStatus();
                            ba.nestlevel = this.iframeStatus.getNestLevel();
                            ba.iframeurls = JSON.stringify(this.iframeStatus.getAncestorUrls().slice(0, - 1));
                            ba.mediation = new q(this.iframeStatus).getMediator();
                            ba.screenwidth = screen.width;
                            ba.screenheight = screen.height;
                            ba.pixelratio = window.devicePixelRatio;
                            p.debug('Iframe status: %s (nest level %s), %s, %s', ba.iframe, this.iframeStatus.getNestLevel(), ba.topdomain, ba.topurl);
                            p.debug('Mediated by %s', ba.mediation);
                            this.parent(y, z, aa, ba);
                            this.adLoaded = false;
                            this.rootWindow = window;
                            if (v())
                                this.rootWindow = window.parent;
                            this.subscribe('xd.adLoading', function(ca) {
                                var da = JSON.parse(ca.data);
                                this.clientEventURL = da.clientEventURL;
                                this.serverDuration = da.serverDuration;
                                this.logEvent('ADNW_ADLOADING');
                            }.bind(this));
                            this.subscribe('xd.adLoaded', function(ca) {
                                this.checkScriptOrigin();
                                this.adLoaded = true;
                                var da = JSON.parse(ca.data);
                                if (da.placementId !== ba.placementid && da.placementId !== ba['data-placementid'])
                                    return;
                                var ea = void 0, fa = void 0, ga = ba.nativeadid || ba['data-nativeadid'], ha = ga && document.getElementById(ga);
                                this.webAdFormat = ba.format || ba['data-format'];
                                if (da.nativeAd) {
                                    if (v()) {
                                        fa = this.iframeStatus.getEnclosingIframe();
                                    } else 
                                        fa = ha;
                                    ea = ha;
                                } else if (v()) {
                                ...
                                if (da.success) {
                                    if (da.nativeAd) {
                                        this.loadNativeAd(ha, da.nativeAd, da.nativeCarouselAds);
                                    } else 
                                        this.elem.style.display = null;
                                    var ia = r.appendToUrl(da.nativeImpURL, {
                                        hosturl: this.iframeStatus.getTopUrl()
                                    });
                                    this.setupViewability(ea, fa, ia);
                                    k.fire('ad.loaded', da.placementId);
                                    this.logEvent('ADNW_ADLOADED');
                                } else {
                                    if (ha)
                                        ha.style.display = 'none';
                                    this.clientEventURL = da.clientEventURL;
                                    this.logEvent('ADNW_ADERROR');
                                    k.fire('ad.error', da.errorCode, da.errorMsg, da.placementId);
                                }
                            }.bind(this));
                            j.add(window, 'pagehide', function() {
                                if (!this.adLoaded)
                                    this.logEvent('ADNW_UNLOAD_BEFORE_ADLOADED');
                            }.bind(this));
                        },
                        sendImpression: function(y) {
                            u.sendToFacebook(this._iframeOptions.name, {
                                method: 'impress',
                        ...
                        setupViewability: function(y, z, aa) {
                            var ba = void 0, ca = this.iframeStatus.getSafeFrameAPI();
                            if (ca) {
                                if (this.iframeStatus.getStatus() === 'NESTED_SAFE_FRAME')
                                    ca = new m(ca);
                                ba = new t(ca, y);
                            } else 
                                ba = new s(this.rootWindow, z);
                            ba.checkViewability(function(da) {
                                var ea = {
                                    web_ad_format: this.webAdFormat,
                                    width: undefined,
                                    height: undefined
                                };
                                if (da) {
                                ...
                                this.sendImpression(r.appendToUrl(aa, ea));
                            }.bind(this), this.logEvent.bind(this));
                        },
                        getParams: function() {
                            return {
                                clickprefix: 'string',
                        ...
                        logEvent: function(y) {
                            if (!this.clientEventURL)
                                return;
                            var z = Date.now(), aa = {
                                client_ts: z,
                                event_name: y,
                                latency: z - this.creationTs,
                                server_duration: this.serverDuration,
                                latency_since_navigation_start: undefined,
                                latency_since_sdk_init: undefined
                            };
                            if (window.performance && window.performance.timing && window.performance.timing.navigationStart)
                                aa.latency_since_navigation_start = z - window.performance.timing.navigationStart;
                            if (window._fb_adnw_init)
                                aa.latency_since_sdk_init = z - window._fb_adnw_init;
                            this.sendSignal(r.appendToUrl(this.clientEventURL, aa));
                            p.debug('Event logged: %s', y);
                        },
                        loadImage: function(y, z) {
                            y.appendChild(this.createAdImage(z));
                        },
                        loadVideo: function(y, z) {
                            var aa = document.createElement('source');
                            aa.src = z.adVideo;
                            var ba = 'data:image/png;base64,' + 'iVBORw0KGgoAAAANSUhEUgAAAAEAAAABAQMAAAl21bKAAAAA1BMVEUAAACneAj3aAAAAA' + 'XRSTlMAQObYZgAAAApJREFUCB1jYAAAAAIAAc/INeUAAAAASUVORK5CYII=', ca = document.createElement('video');
                            ca.style.height = '100%';
                            ca.style.width = '100%';
                            ca.style.opacity = '0';
                            ...
                            ca.poster = ba;
                            ca.preload = 'metadata';
                            ca.setAttribute('webkit-playsinline', 'true');
                            ca.appendChild(aa);
                            var da = document.createElement('div'), ea = document.createElement('div'), fa = 'url(\'' + (z.adImage || '') + '\')';
                            j.add(ca, 'ended', function() {
                                if (z.videoTimeLink)
                                    this.sendSignal(r.appendToUrl(z.videoTimeLink, this.getVideoParams(ca, true)));
                                z.videoPlayLogged = false;
                                ca.src = ca.currentSrc;
                                da.style.display = 'block';
                                ea.style.backgroundImage = fa;
                                ca.style.opacity = 0;
                                ca.style.visibility = 'hidden';
                                if (ca.exitFullscreen) {
                                    ca.exitFullscreen();
                                } else if (ca.mozCancelFullScreen) {
                                    ca.mozCancelFullScreen();
                                } else if (ca.webkitExitFullscreen)
                                    ca.webkitExitFullscreen();
                            }.bind(this));
                            j.add(ca, 'timeupdate', function() {
                                if (ca.currentTime >= w&&!z.videoPlayLogged && z.videoPlayLink) {
                                    this.sendSignal(r.appendToUrl(z.videoPlayLink, this.getVideoParams(ca, false)));
                                    z.videoPlayLogged = true;
                                }
                            }.bind(this));
                            ea.style.height = '100%';
                            ea.style.width = '100%';
                            ...
                            ea.style.backgroundRepeat = 'no-repeat';
                            ea.style.backgroundSize = 'contain';
                            var ga = document.createElement('div');
                            ga.style.borderBottom = '12.5px solid rgba(0, 0, 0, 0)';
                            ga.style.borderLeft = '21px solid #fff';
                            ga.style.borderTop = '12.5px solid rgba(0, 0, 0, 0)';
                            ga.style.left = '23px';
                            ga.style.position = 'relative';
                            ga.style.top = '18px';
                            var ha = document.createElement('div');
                            ha.style.backgroundColor = 'rgba(0, 0, 0, 0.6)';
                            ha.style.borderRadius = '30px';
                            ha.style.height = '60px';
                            ha.style.margin = '0 auto';
                            ha.style.width = '60px';
                            ha.appendChild(ga);
                            j.add(ha, 'click', function(event) {
                                da.style.display = 'none';
                                ea.style.backgroundImage = null;
                                ca.style.opacity = 1;
                            ...
                            da.style.top = '-50%';
                            da.style.left = '50%';
                            da.style.transform = 'translate(-50%, -50%)';
                            da.style.webkitTransform = 'translate(-50%, -50%)';
                        ...
                        loadMPA: function(y, z, aa) {
                            var ba = document.createElement('div'), ca = ba.style;
                            ca.height = '100%';
                            ca.width = '100%';
                            ca.overflow = 'hidden';
                            ca.boxShadow = 'inset 0px 1px 0px 0px rgba(0, 0, 0, 0.2),' + 'inset 0px -1px 0px 0px rgba(0, 0, 0, 0.2)';
                            ca.backgroundColor = '#e9eaed';
                            var da = document.createElement('div'), ea = da.style;
                            ea.height = '100%';
                            ea.overflow = 'hidden';
                            ea.transition = 'all 150ms ease-out';
                            ea.paddingTop = i.VERTICAL_MARGIN + 'px';
                            ba.appendChild(da);
                            for (var fa = aa, ga = Array.isArray(fa), ha = 0, fa = ga ? fa : fa[typeof Symbol === 'function' ? Symbol.iterator: '@@iterator'](); ;) {
                                var ia;
                                if (ga) {
                                    if (ha >= fa.length)
                                        break;
                                ...
                                var ja = ia, ka = document.createElement('a'), la = ka.style;
                                la.display = 'inline';
                                la.float = 'left';
                                la.boxShadow = '0px 0px 4px 0px rgba(0, 0, 0, 0.1),' + 'inset 0px 0px 0px 1px rgba(0, 0, 0, 0.2)';
                                la.borderRadius = '1px';
                                la.backgroundImage = 'url(' + (ja.adImage || '') + ')';
                                la.backgroundSize = 'cover';
                                la.cursor = 'pointer';
                                this.installLink(ka, ja);
                                da.appendChild(ka);
                            }
                            y.appendChild(ba);
                            var ma = new i(aa.length, ba, da);
                            ma.subscribe('impress', function(na) {});
                        },
                        installLink: function(y, z) {
                            var aa = z.href, ba = z.clickReportURL;
                            j.add(y, 'click', function(ca) {
                                u.sendToFacebook(this._iframeOptions.name, {
                                    method: 'click',
                                    params: JSON.stringify({
                                        href: aa,
                        ...
                        loadNativeAd: function(y, z, aa) {
                            if (!y ||!z || z.loaded)
                                return;
                            z.loaded = true;
                            var ba = void 0, ca = y.getElementsByClassName('fbAdLink');
                            for (ba = 0; ba < ca.length; ba++)
                                this.installLink(ca[ba], z);
                            var da = y.getElementsByClassName('fbAdIcon');
                            for (ba = 0; ba < da.length; ba++)
                                da[ba].appendChild(this.createAdIcon(z));
                            var ea = null;
                            if (aa) {
                                ea = function(la) {
                                    return this.loadMPA(la, z, aa);
                                }.bind(this);
                            } else if (z.adVideo) {
                                ea = function(la) {
                                    return this.loadVideo(la, z);
                                }.bind(this);
                            } else 
                                ea = function(la) {
                                    return this.loadImage(la, z);
                                }.bind(this);
                            var fa = y.getElementsByClassName('fbAdMedia');
                            for (ba = 0; ba < fa.length; ba++)
                                ea.call(this, fa[ba]);
                            var ga = y.getElementsByClassName('fbAdTitle');
                            for (ba = 0; ba < ga.length; ba++)
                                ga[ba].textContent = z.adTitle;
                            var ha = y.getElementsByClassName('fbAdSubtitle');
                            for (ba = 0; ba < ha.length; ba++)
                                ha[ba].textContent = z.adSubtitle;
                            var ia = y.getElementsByClassName('fbAdBody');
                            for (ba = 0; ba < ia.length; ba++)
                                ia[ba].textContent = z.adBody;
                            var ja = y.getElementsByClassName('fbAdCallToAction');
                            for (ba = 0; ba < ja.length; ba++)
                                ja[ba].textContent = z.adCallToAction;
                            var ka = y.getElementsByClassName('fbAdSocialContext');
                            for (ba = 0; ba < ka.length; ba++)
                                ka[ba].textContent = z.adSocialContext;
                            y.appendChild(this.createAdChoices(z));
                        },
                        getClientParam: function() {
                            return JSON.stringify({
                                cd: this._impTime ? Date.now() - this._impTime: 0
                            });
                        },
                        getVideoParams: function(y, z) {
                            var aa = {};
                            if (z)
                                aa.time = y.currentTime;
                            var ba = y.webkitDisplayingFullscreen || l === y;
                            aa.inline = ba ? '0' : '1';
                            aa.autoplay = y.autoplay ? '1' : '0';
                            aa.volume = y.volume;
                            return aa;
                        },
                        createAdChoices: function(y) {
                            var z = document.createElement('div');
                            z.style.backgroundColor = '#000';
                            z.style.borderBottomRightRadius = '8px';
                            z.style.left = '0';
                            z.style.lineHeight = '12px';
                            z.style.padding = '2px 2px 2px 2px';
                            z.style.position = 'absolute';
                            z.style.top = '0';
                            var aa = document.createElement('a');
                            aa.innerText = 'AdChoices';
                            aa.href = y.adChoicesHref;
                            aa.style.color = '#ccc';
                            aa.style.display = 'inline-block';
                            aa.style.fontSize = '10px';
                            aa.style.height = '10px';
                            aa.style.lineHeight = '10px';
                            aa.style.overflow = 'hidden';
                            aa.style.left = 0;
                            aa.style.paddingLeft = '0px';
                            aa.style.textDecoration = 'none';
                            aa.style.top = 0;
                            aa.style.transition = '0.3s';
                            ...
                            ba.src = y.adChoicesIcon;
                            ba.style.backgroundColor = '#000';
                            ba.style.height = '12px';
                            ba.style.verticalAlign = 'bottom';
                            ba.style.width = '12px';
                            z.appendChild(ba);
                            j.add(ba, 'click', function() {
                                aa.style.paddingLeft = '2px';
                        ...
                        checkScriptOrigin: function() {
                            try {
                                throw new Error('');
                            } catch (y) {
                                var z = y.stack;
                                if (z) {
                                    var aa = /:\/\/.*\.facebook\.com\/assets\.php\/.*\/xfbml\.ad\.js/i, ba = /:\/\/connect\.facebook\.net\/.*\/xfbml\.ad\.js/i;
                                    if (aa.test(z)) {
                                        this.logEvent('ADNW_SDK_LOADED_FROM_ASSETS_PHP');
                                    } else if (!ba.test(z))
                                        this.logEvent('ADNW_SDK_NOT_LOADED_FROM_CDN');
                                } else 
                                    this.logEvent('ADNW_SDK_LOADED_FROM_UNKNOWN_SOURCE');
                            }
                        }
                    });
                    f.exports = x;
                }, null);
                __d('legacy:fb.xfbml.ad', ['sdk.XFBML.Ad', 'XFBML'], function a(b, c, d, e, f, g, h, i) {
                    if (c.__markCompiled)
                        c.__markCompiled();
                    i.registerTag({
                        xmlns: 'fb',
    ...
    new Image().src = "https:\/\/www.facebook.com\/" + 'common/scribe_endpoint.php?c=jssdk_error&m=' + encodeURIComponent('{"error":"LOAD", "extra": {"name":"' + e.name + '","line":"' + (e.lineNumber || e.line) + '","script":"' + (e.fileName || e.sourceURL || e.script) + '","stack":"' + (e.stackTrace || e.stack) + '","revision":"2356307","namespace":"FB","message":"' + e.message + '"}}');
}
